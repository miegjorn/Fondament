...
| 3 — Escalate | Public interface change, new cross-component protocol, Fondament definition change, anything that affects A-1 through A-8 | Surface to Pierre-Luc via matrix_request_approval; do not dispatch |
